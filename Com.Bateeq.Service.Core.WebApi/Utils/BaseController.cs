...
using Com.Bateeq.Service.Core.Lib.Interfaces;
...
using General = Com.Bateeq.Service.Core.WebApi.Helpers.General;

namespace Com.Bateeq.Service.Core.WebApi.Utils
{
