using AutoMapper;
using Com.Bateeq.Service.Core.Lib.Helpers.IdentityService;
using Com.Bateeq.Service.Core.Lib.Helpers.ValidateService;
...
using Com.Bateeq.Service.Core.WebApi.Utils;
using CsvHelper;
...
namespace Com.Bateeq.Service.Core.WebApi.Controllers.v1.MachineSpinning
{
