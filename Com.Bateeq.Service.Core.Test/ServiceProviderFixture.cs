...
using Com.Bateeq.Service.Core.Lib.Services.MachineSpinning;
...
namespace Com.Bateeq.Service.Core.Test
{
    public class ServiceProviderFixture : IDisposable
    {
        ...
        public ServiceProviderFixture()
        {
            IConfigurationRoot configuration = new ConfigurationBuilder()
                ...
                {
                    new KeyValuePair<string, string>("Secret", "BateeqTESTENVIRONMENT"),
					new KeyValuePair<string, string>("ASPNETCORE_ENVIRONMENT", "Test"),
					new KeyValuePair<string, string>("DefaultConnection",  "Server=localhost,1401; Database = com.Bateeq.db.core.service.test; User = sa; password = Standar123.; MultipleActiveResultSets = true; ")
